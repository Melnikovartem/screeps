...
HEALER.patternLimit = Math.ceil(TOWER_DMG / (HEAL_POWER * BOOSTS.heal.XLHO2.heal)) + 1;

// my most powerfull weapon to date
export class DismanleBoys extends SquadMaster {
  boosts: Boosts = [{ type: "rangedAttack", lvl: 1 }, { type: "dismantle", lvl: 2 }, { type: "heal", lvl: 2 }, { type: "damage", lvl: 2 }, { type: "fatigue", lvl: 1 }];
