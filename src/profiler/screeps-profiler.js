...
// i copy this file to screeps-profiler in node module cause i didn't get how to import in typescript -_-
...
const Profiler = {
  ...
  isProfiling () {
    ...
    if (!Game) { return false } // WOW a custom if made by me for MY private server
